...
class UTextStyles{
  ...
  static TextStyle title13_500w({Color? color}) => GoogleFonts.poppins(fontSize: 13.sp, fontWeight: FontWeight.w500, color: color);
  ...
  static TextStyle rTitle14_500w({Color? color}) => GoogleFonts.roboto(fontSize: 14.sp, fontWeight: FontWeight.w500, color: color);
